...
1. Reálná funkce více reálných proměnných (definice, definiční obor a obor hodnot, graf funkce dvou proměnných, parciální derivace, lokální, vázané a globální extrémy), aproximace metodou nejmenších čtverců (motivace a geometrický význam, formulace, řešení, aplikace na nelineární funkce např. v elektronice)
